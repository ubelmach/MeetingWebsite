...
namespace MeetingWebsite.BLL.Services
{
    public class SearchService : ISearchService
    {
        ...
        public IQueryable<User> FindUsers(SearchByCriteriaViewModel criteria)
        {
            ...
            //users = users.FilterBy(SearchHelper.PurposeOfDatingCriteria, criteria.PurposeOfDating);
            //users = users.FilterBy(SearchHelper.KnowledgeOfLanguagesCriteria, criteria.KnowledgeOfLanguages);
            //users = users.FilterBy(SearchHelper.BadHabitsCriteria, criteria.BadHabits);
            //users = users.FilterBy(SearchHelper.PurposeOfDatingCriteria, criteria.Interests);
